...
class CityscapesSegmentation(data.Dataset):
    ...
    def transform_tr(self, sample):
        composed_transforms = transforms.Compose([
            ...
            #tr.FixedResize(size=(1024, 512)), # (512,256) -> w x h
    ...
    def transform_val(self, sample):
        ...
        composed_transforms = transforms.Compose([
            tr.FixScaleCrop(crop_width=self.args.crop_width, crop_height=self.args.crop_height), # annotation
    ...
    def transform_ts(self, sample):
        ...
        composed_transforms = transforms.Compose([
            #tr.FixedResize(size=self.args.crop_size), # annotation
            tr.FixedResize(size=(1024, 512)),
            tr.Normalize(mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)),
            tr.ToTensor()])
...
if __name__ == '__main__':
    ...
    fixed_resize = tr.FixedResize(size=(512, 256))
